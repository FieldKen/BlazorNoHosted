...
namespace BlazorNoHosted.Pages
{
	...
	{
		public List<StoryQuestion> Questions = new List<StoryQuestion>();
        ...
        public Story()
		{
			Questions.Add(new StoryQuestion(
				[
	...
	public class StoryQuestion
	{
		...
		public StoryQuestion(List<string> fullStory, List<string> answers)
		{
			FullStory = fullStory;
			Answers = answers;
		}
